...
OUT_HEADER = ["S.No.", "AOC Date", "e-Published Date", "Title and Ref.No./Tender Id", "State Name", "Tender ID", "Organisation Name", "Tender Ref. No.", "Tender Description", "Tender Type", "Number of bids received", "Name of the selected bidder(s)", "Address of the selected bidder(s)", "Contract Value", "Tender Published Date", "Contract Date", "Date of Completion/Completion Period in Days"]
...
class EprocMmpAocHPscraper(SeleniumScrappingUtils):
    ...
    def get_tender_results(self, output_file):
        ...
        while True:
            ...
            time.sleep(SLEEP_TIME)
            previous_button = self.get_page_element(xpath="//a[@class='page_parination' and contains(.,'Previous')]")
...
if __name__ == '__main__':
    ...
    obj.get_tender_results("aoc_all_records2.csv")     
